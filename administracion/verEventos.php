            ...
            <div class="card-body">
              ...
              <div class="row">
                  ...
                  <div class="col-12 " id="filtros">
                      <form action="verEventos.php" method="GET">
                        ...
                        <table class="table table-hover" id="tblLST" width="100%" cellspacing="0">
                         ...
                         <?php
                             ...
                             if (isset($_GET["CAT"])) {
                              ...
                              $filtro=""; //el filtro predeterminado, trae todos los eventos excepto los dados DE BAJA y los EVENTOS PASADOS

                              if ($est=="" && $cat=="") {
                                $filtro = "WHERE estEVENT!='DE BAJA' AND estEVENT!='EVENTO PASADO'";
                               // echo "Estan los 2 putos vacios";
                              }
                              if ($est!="" && $cat=="") {
                                $filtro = "WHERE estEVENT='$est' AND estEVENT!='DE BAJA' AND estEVENT!='EVENTO PASADO' ";
                               // echo "Estado tiene algo y categoria no";
                              }
                              if ($est!="" && $cat!="") {
                                $filtro = "WHERE estEVENT='$est' AND estEVENT!='DE BAJA' AND estEVENT!='EVENTO PASADO' AND catEVENT='$cat' ";
                               // echo "Estado tiene algo y categoria tambien";
                              }
                              if ($est=="" && $cat!="") {
                                $filtro = "WHERE catEVENT='$cat' AND estEVENT!='DE BAJA' AND estEVENT!='EVENTO PASADO' ";
                                      ...
                                      echo " <td><span class='$clase'>$estado</span></td>
                                             ...
                                             <td class='iconitos'>
                                                 <a href=\"javascript:window.parent.location.href='ProcesoEventosUPD.php?ID=$id' \" data-toggle='tooltip' title='Editar'>
                                                  ...
                                                  <a href=\"javascript:DeleteREG($id,1)\" data-toggle='tooltip' title='Eliminar'>
